...
export  function Projects(props) {
  ...
  const projects = [
    ...
    { id: 7, 
      ...
      date: "July 2023",
      image: `${blogImage7}`,
      description: "Van hiring service with integrated frontend and backend with user profiles, booking and availability system, and review system. Full stack MERN application styled with Tailwind.",
    },
  ]
